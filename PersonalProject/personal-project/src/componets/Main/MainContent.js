export default function MainContent() {
  return ` <div class="container ">
      ...
      <div class="column2">
        ...
        <div class="col2-row1">
         ...
         <!-- Project --> 
          ...
          <p>CountDown Time</p>
          <hr />
          <p class="prueba">Product Upcoming Page</p>
        </div>
        <!-- Work Experience -->
        <div class="col2-row2">
          
          <h3 class="h3-titulo">Work Experience</h3>
          <h4 class="h4-titulo">roadmap.sh</h4>
          <p>Solve all the frontend project </p>
          <p class="visit">Visit my Profile</p>
          <hr />
          <!-- Open Source Work -->
          <h3 class="h3-titulo">OpenSource Work</h3>
          <p>
            Contributed to 50 Opensource <br />
            project. Made my own project with <br />
            200 GitHub stars
          </p>
          <p class="visit">Visit my GitHub Profile</p>
        </div>
        <!-- Education -->
        <div class="col2-row3">
          <h3 class="h3-titulo">Education</h3>
          <p>
      ...
      <div class="column3">
        ...
        <h3 class="h3-titulo">Reviews from my Teachers</h3>
        <div class="cuadro1">
          <p class="p-text">
